...
function MenuSection({ sectionKey, itemKeys, t }) {
  ...
  return (
    <section className="mb-16">
      ...
      <div className="w-16 h-0.5 bg-gold mx-auto mb-6 sm:mb-10"></div>
    ...
    <div>
      <div className="relative h-48 sm:h-56 md:h-64 bg-cover bg-center flex items-center justify-center"
        ...
        <div className="relative text-center text-white z-10 px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-display mb-2">{t.menu.heroTitle}</h1>

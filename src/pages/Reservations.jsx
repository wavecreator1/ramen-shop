    ...
    <div>
      <div className="relative h-48 sm:h-64 bg-cover bg-center flex items-center justify-center"
        ...
        <div className="relative text-center text-white z-10 px-4">
          <h1 className="text-3xl sm:text-5xl font-bold font-display mb-2">{t.reservations.heroTitle}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-muted mb-2">
                    {t.reservations.confirmedMessage(formData.name, formData.guests, formData.date, formData.time)}
                  </p>
                  <p className="text-muted text-sm">
                    {t.reservations.confirmationSent(formData.email)}
                  </p>
                  <button
                    onClick={() => {
                      setSubmitted(false)
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-1">{t.reservations.labelPartySize}</label>
                    <select
                      name="guests"
          ...
          {/* Location & Hours */}
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-charcoal font-display mb-4 sm:mb-6">{t.reservations.findUs}</h2>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="bg-light-gold h-56 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-warm-brown/50 mt-2 italic">{t.reservations.mapComingSoon}</p>
                  </div>
                </div>
              </div>

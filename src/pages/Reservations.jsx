    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid grid-cols-2 gap-16">
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-muted mb-2">
                    {t.reservations.confirmedMsg(formData.name, formData.guests, formData.date, formData.time)}
                  </p>
                  <p className="text-muted text-sm">
                    {t.reservations.confirmationEmail(formData.email)}
                  </p>
                  <button
                    onClick={() => {
                      setSubmitted(false)
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold"
                      >
                        <option value="">{t.reservations.placeholderTime}</option>
          ...
          {/* Location & Hours */}
          <div>
            <h2 className="text-3xl font-bold text-charcoal font-display mb-6">{t.reservations.findUs}</h2>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="bg-light-gold h-56 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-warm-brown/50 mt-2 italic">{t.reservations.mapPlaceholder}</p>
                  </div>
                </div>
              </div>

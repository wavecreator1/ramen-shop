    ...
    <div>
      <div className="relative h-40 md:h-64 bg-cover bg-center flex items-center justify-center"
        ...
        <div className="relative text-center text-white z-10 px-4">
          <h1 className="text-3xl md:text-5xl font-bold font-display mb-2">{t.ourStory.heroTitle}</h1>
          <p className="text-sm md:text-lg text-white/80">{t.ourStory.heroSubtitle}</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:px-8 md:py-16">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-charcoal font-display mb-6">{t.ourStory.originTitle}</h2>
        ...
        {/* Philosophy */}
        <section className="mb-20">
          <h2 className="text-2xl md:text-3xl font-bold text-charcoal font-display text-center mb-12">{t.ourStory.philosophyTitle}</h2>
        ...
        {/* Timeline */}
        <section>
          <h2 className="text-2xl md:text-3xl font-bold text-charcoal font-display text-center mb-4">{t.ourStory.milestonesTitle}</h2>

          ...
          <div className="grid grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted leading-relaxed">
                <p>
                  Ichiban Ramen was born from a simple dream: to bring the authentic flavors of Japan&apos;s finest
                  ramen shops to New York City. Our founder, Chef Takeshi Yamamoto, spent two years apprenticing
                  under legendary ramen masters in Tokyo and Fukuoka, learning the art and science of crafting the
                  perfect bowl.
                </p>
                <p>
                  What started as a weekend pop-up at Brooklyn food markets quickly became the talk of the city.
                  Lines stretched around the block as word spread about our impossibly rich tonkotsu broth and
                  handmade noodles. In 2015, we opened our doors on Noodle Street, and we haven&apos;t looked back since.
                </p>
                <p>
                  Today, Ichiban Ramen is more than a restaurant. It&apos;s a gathering place where families, friends,
                  and ramen lovers come together over steaming bowls of comfort, united by the belief that great
          ...
          <div className="grid grid-cols-2 gap-12">
            <div className="bg-cream rounded-xl p-8">
              ...
              <p className="text-muted leading-relaxed">
                Our tonkotsu broth is the soul of every bowl. We simmer premium pork bones for a minimum of 18
                hours at a rolling boil, extracting every ounce of collagen and flavor. The result is a broth so
                rich and creamy it coats the noodles like silk. We never take shortcuts, never use concentrates,
                and never compromise. Each batch is tasted and approved by Chef Yamamoto himself before a single
                bowl is served.
              </p>
            </div>
            <div className="bg-cream rounded-xl p-8">
              <h3 className="text-xl font-bold text-charcoal font-display mb-4">The Noodles</h3>
              <p className="text-muted leading-relaxed">
                We make our noodles fresh every morning using a custom blend of premium Japanese flour, kansui
                mineral water, and a technique passed down through generations. Each style of ramen gets its own
                noodle: thin and straight for tonkotsu, wavy and chewy for miso, and medium-width for shoyu. The
                right noodle transforms a good bowl into an unforgettable one, and we obsess over getting it

...
function OurStory() {
  ...
  return (
    <div>
      <div className="relative h-48 sm:h-56 md:h-64 bg-cover bg-center flex items-center justify-center"
        ...
        <div className="relative text-center text-white z-10 px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-display mb-2">{t.ourStory.heroTitle}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
        ...
        {/* Philosophy */}
        <section className="mb-20">
          <h2 className="text-2xl sm:text-3xl font-bold text-charcoal font-display text-center mb-8 sm:mb-12">{t.ourStory.philosophyTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
            <div className="bg-cream rounded-xl p-5 sm:p-8">
              <h3 className="text-lg sm:text-xl font-bold text-charcoal font-display mb-4">{t.ourStory.brothTitle}</h3>
              <p className="text-muted leading-relaxed">
                {t.ourStory.brothText}
              </p>
            </div>
            <div className="bg-cream rounded-xl p-5 sm:p-8">
              <h3 className="text-lg sm:text-xl font-bold text-charcoal font-display mb-4">{t.ourStory.noodlesTitle}</h3>
              <p className="text-muted leading-relaxed">
        ...
        <section>
          ...
          <p className="text-muted text-center mb-8 sm:mb-12">{t.ourStory.milestonesSubtitle}</p>

    ...
    <div>
      <div className="relative h-64 bg-cover bg-center flex items-center justify-center"
        ...
        <div className="relative text-center text-white z-10">
          <h1 className="text-5xl font-bold font-display mb-2">{t.story.heroTitle}</h1>
          <p className="text-lg text-white/80">{t.story.heroSubtitle}</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-charcoal font-display mb-6">{t.story.originTitle}</h2>
        ...
        {/* Philosophy */}
        <section className="mb-20">
          <h2 className="text-3xl font-bold text-charcoal font-display text-center mb-12">{t.story.philosophyTitle}</h2>
          <div className="grid grid-cols-2 gap-12">
            <div className="bg-cream rounded-xl p-8">
              <h3 className="text-xl font-bold text-charcoal font-display mb-4">{t.story.brothTitle}</h3>
              <p className="text-muted leading-relaxed">
                {t.story.brothText}
              </p>
            </div>
            <div className="bg-cream rounded-xl p-8">
              <h3 className="text-xl font-bold text-charcoal font-display mb-4">{t.story.noodlesTitle}</h3>
              <p className="text-muted leading-relaxed">
                {t.story.noodlesText}
              </p>
            </div>
        ...
        {/* Timeline */}
        <section>
          <h2 className="text-3xl font-bold text-charcoal font-display text-center mb-4">{t.story.milestonesTitle}</h2>
          <p className="text-muted text-center mb-12">{t.story.milestonesSubtitle}</p>

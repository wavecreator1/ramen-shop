    ...
    <nav className="bg-charcoal">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 sm:gap-3 no-underline">
          ...
          <div>
            ...
            <p className="text-gold text-[10px] sm:text-xs tracking-widest m-0">
              {t.brand.tagline}
            </p>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button
            ...
            className="text-sm font-medium tracking-wide text-white/80 hover:text-white transition-colors bg-white/10 hover:bg-white/20 px-3 py-1 rounded cursor-pointer border-none"
          >
            {language === 'en' ? 'JP' : 'EN'}
          </button>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-white/10 px-4 pb-4">
          ...
          <button
            onClick={toggleLanguage}
            className="block py-3 text-sm font-medium tracking-wide text-white/80 hover:text-white transition-colors bg-white/10 hover:bg-white/20 px-3 py-1 rounded cursor-pointer border-none mt-2"
          >
            {language === 'en' ? 'JP' : 'EN'}
          </button>
        </div>
